...
export default function Page() {
  ...
  return (
    ...
    <main className="min-h-screen bg-black pt-14 sm:pt-16">
      <Head>
      ...
      <div className="mainn">
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://comestart.sentry.io/issues/?project=4509320909815808">Issues Page</a>.
